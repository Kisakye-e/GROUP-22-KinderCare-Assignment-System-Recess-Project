<html>
    ...
    <P class="navbar-brand" ><span class="glyphicon glyphicon-list"></span>KINDER CARE EDUCATION CENTRE</P>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="registerPupil.php">Register Pupil</a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="activationRequests.php">View Activation Requests</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="assignmentActivity.php">Assignment Activity</a>
      </li>
    </ul>
